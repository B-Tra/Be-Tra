        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Already Listed Address</h1>
                </div>
...
<div class="col-6">
          <table class="table">
            <thead>
                <tr>
                    <th colspan="4"><h5>Shopping Address</h5></th>
                </tr>
            </thead>
            <tr>
                <thead>
...
<form method="post" name="address">
     ...
     <div class="row">
       ...
       <div class="row mt-3">
        ...
        <div class="col-6">
               <div class="row">
         <div class="col-9" align="center"><h5>New Shopping Address</h5> 
